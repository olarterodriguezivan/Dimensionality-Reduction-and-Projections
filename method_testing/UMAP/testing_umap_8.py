...
import numpy as np
from dimensionality_reduction import UMAPTorchSupervised
...
umap_model = UMAPTorchSupervised(n_components=n_components,
...
X_reduced = umap_model.fit_transform(X,y_values)
