...
import numpy as np
from dimensionality_reduction import UMAPTorch
...
weights = get_rank_based_weighting(method="logarithmic").compute_weights(values=y_values,decay=0.4)


# Initialize Weighted PCA
umap_model = UMAPTorch(n_components=n_components,
...
X_reduced = umap_model.fit_transform(X,y_values, sample_weights=weights)
