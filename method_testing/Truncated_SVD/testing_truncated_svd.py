...
import numpy as np
from dimensionality_reduction import TruncatedSVDWrapper
...
weighted_pca = TruncatedSVDWrapper(n_components=n_components)
...
if n_components == 2:
    ...
    plt.title('SVD Dimensionality Reduction of BBOB Function Samples')
